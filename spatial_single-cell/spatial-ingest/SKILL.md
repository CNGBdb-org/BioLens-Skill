...
name: spatial-ingest
description: >-
  Ingest spatial transcriptomics into AnnData with obsm spatial coordinates (Visium-like h5ad or demo). Foundation for spatial QC/SVG/deconv/interaction skills. Not for HESTA portal maps (use hesta), scRNA-only ingest (use sc-ingest), or GEO discovery (use geo-sra).
...
metadata:
  ...
  depth: L5
  domain: cell-spatial
  capability_id: cngbdb.spatial.spatial-ingest.v1
...
- 读入含 obsm['spatial'] 的 AnnData / demo
