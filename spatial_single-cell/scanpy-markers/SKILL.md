...
name: scanpy-markers
description: >-
  Rank marker genes per cluster with Scanpy wilcoxon. Use after clustering to find cluster markers. Not for clustering itself (use scanpy-cluster) or HESTA paper markers (use hesta).
...
metadata:
  ...
  depth: L5
  domain: single-cell
  capability_id: cngbdb.scrna.scanpy-markers.v1
...
- 按 cluster 做 wilcoxon marker 排序
