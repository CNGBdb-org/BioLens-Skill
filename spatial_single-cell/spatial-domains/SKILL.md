...
metadata:
  ...
  depth: L5
  domain: cell-spatial
  capability_id: cngbdb.spatial.spatial-domains.v1
...
|------|------|
| 空间可变基因 | `spatial-svg` |
| spot 解卷积比例 | `spatial-deconv` |
| 细胞类型标签 | `spatial-annotate` / `celltypist-annotate` |
