...
name: spatial-deconv
description: >-
  Baseline spatial deconvolution with NMF factor proportions per spot. Self-built Squidpy/SpatialData-stack skill for cell-type mixture approximation. Not for HESTA celltype maps (use hesta) or neighborhood interaction (use spatial-interaction).
...
metadata:
  ...
  depth: L5
  domain: cell-spatial
  capability_id: cngbdb.spatial.spatial-deconv.v1
