...
name: spatial-qc
description: >-
  Spatial transcriptomics QC: counts/genes metrics and spatial QC maps. Use Squidpy/SpatialData-oriented workflow on AnnData with spatial coordinates. Not for HESTA QC plots (use hesta) or scRNA QC without spatial (use scanpy-qc).
...
metadata:
  ...
  depth: L5
  domain: cell-spatial
  capability_id: cngbdb.spatial.spatial-qc.v1
...
- 空间 counts/genes 指标与 QC 图

## Do Not Use When

| 需求 | 交给 |
|------|------|
| 无空间坐标的 scRNA QC | `scanpy-qc` |
| HESTA 图谱探索 | `hesta` |
| 空间可变基因 | `spatial-svg` |
